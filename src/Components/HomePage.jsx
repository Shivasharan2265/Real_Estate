            ...
            <!-- Benefit --> */}
                            ...
                            <div className="wrap-property">
                                <div className="box-left  wow fadeInLeftSmall" data-wow-delay=".2s" data-wow-duration="2000ms">
                                    <div className="homeya-box lg">
                                        <div className="archive-top">
                                            ...
                                            <div className="content">
                                                <h5 className="text-capitalize"><a href="property-details-v1.html" className="link"> Rancho Vista Verde, Santa Barbara</a></h5>
                                                <div className="desc"><i className="icon icon-mapPin"></i><p>145 Brooklyn Ave, Califonia, New York</p> </div>
                                                <p className="note">"I truly appreciate the professionalism and in-depth...</p>
                                                <ul className="meta-list">
                                                    <li className="item">
                                                        <i className="icon icon-bed"></i>
                                ...
                                <div className="box-right wow fadeInRightSmall" data-wow-delay=".2s" data-wow-duration="2000ms">
                                    <div className="homeya-box list-style-1">
                                        ...
                                        <div className="content">
                                            <div className="archive-top">
                                                <div className="h7 text-capitalize fw-7"><a href="property-details-v1.html" className="link">Lakeview Haven, Lake Tahoeeee</a></div>
                                                <div className="desc"><i className="icon icon-mapPin"></i><p>145 Brooklyn Ave, Califonia, New York</p> </div>
                                                <ul className="meta-list">
                                                    <li className="item">
                                                        <i className="icon icon-bed"></i>
                                    ...
                                    <div className="homeya-box list-style-1">
                                        ...
                                        <div className="content">
                                            <div className="archive-top">
                                                <div className="h7 text-capitalize fw-7"><a href="property-details-v1.html" className="link">Casa Lomas de Machalí Machas</a></div>
                                                <div className="desc"><i className="icon icon-mapPin"></i><p>145 Brooklyn Ave, Califonia, New York</p> </div>
                                                <ul className="meta-list">
                                                    <li className="item">
                                                        <i className="icon icon-bed"></i>
                    ...
                    <section className="flat-section-v3 flat-latest-new bg-surface">
                        <div className="container">
                            ...
                            <div className="row">
                                {home.blogs.map((blog, idx) => (
                                    <div className="box col-lg-4 col-md-6" key={idx}>
                                        <a href={blog.url} className="flat-blog-item hover-img wow fadeIn" data-wow-delay={`.${2 + idx * 2}s`} data-wow-duration="2000ms">
                                            <div className="img-style">
                                                <img src={blog.image} alt="img-blog" />
                                                <span className="date-post">{blog.date}</span>
                                            </div>
                                            <div className="content-box">
                                                <div className="post-author">
                                                    <span className="fw-6">{blog.author}</span>
